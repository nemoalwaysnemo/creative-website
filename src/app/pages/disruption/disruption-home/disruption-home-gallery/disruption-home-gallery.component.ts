...
import { NuxeoPagination, DocumentModel, NuxeoSearchParams } from '@core/api';
...
export class DisruptionHomeGalleryComponent implements OnInit, OnDestroy {
  ...
  private getItems(): void {
    this.subscription = this.documentPageService.advanceRequest(new NuxeoSearchParams(this.gallerySwitch)).pipe(
