...
import { BizDevCaseFolderFormComponent } from './biz-dev-case-folder-form.component';
import { BizDevCaseAssetFormComponent } from './biz-dev-case-asset-form.component';
...
export const GLOBAL_DOCUMENT_FORM = {
  ...
  BIZ_DEV_CASE_FORM: BizDevCaseFolderFormComponent,
  BIZ_DEV_CASE_ASSET_FORM: BizDevCaseAssetFormComponent,
  BIZ_DEV_THOUGHT_FORM: BizDevThoughtFolderFormComponent,
