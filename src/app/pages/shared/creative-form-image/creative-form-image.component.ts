...
@Component({
  selector: 'creative-form-image',
  templateUrl: './creative-form-image.component.html',
})
export class CreativeFormImageComponent extends AbstractCreativeForm {

  protected parentType: string = AbstractCreativeForm.IMAGE_ASSET;
