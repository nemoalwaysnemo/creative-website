...
@Component({
  selector: 'tbwa-my-brand-search-result',
  styleUrls: ['./my-brand-search-result.component.scss'],
  templateUrl: './my-brand-search-result.component.html',
})
export class MyBrandSearchResultComponent extends BaseSearchResultComponent implements OnInit, OnDestroy {
