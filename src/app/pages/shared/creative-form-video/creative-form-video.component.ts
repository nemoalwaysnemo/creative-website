...
@Component({
  selector: 'creative-form-video',
  templateUrl: './creative-form-video.component.html',
})
export class CreativeFormVideoComponent extends AbstractCreativeForm {

  protected parentType: string = AbstractCreativeForm.VIDEO_ASSET;
