...
export class CreativePopularBrandAssetSearchComponent extends GlobalDocumentViewComponent {
  ...
  filters: SearchFilterModel[] = [
    ...
    new SearchFilterModel({ key: 'the_loupe_main_campaign_agg', placeholder: 'Campaign', visibleFn: (searchParams: GlobalSearchParams): boolean => searchParams.hasParam('the_loupe_main_agency_agg') }),
