...
export const encodePath = function (path: string): string {
...
export const getDeepFromObject = function (object: any = {}, name: string, defaultValue?: any): any {
...
export const b64decode = function (str: string): string {
...
export const b64DecodeUnicode = function (str: any): string {
  return decodeURIComponent(Array.prototype.map.call(b64decode(str), (c: any) => {
    return '%' + ('00' + c.charCodeAt(0).toString(16)).slice(-2);
  }).join(''));
};

export const urlBase64Decode = function (str: string): string {
