...
} from '@core/nebular/auth/auth.options';
import { NbAuthJWTInterceptor, NbAuthService } from '@core/nebular/auth';
import { NbTokenService } from '@core/nebular/auth/services/token/token.service';
import { NbTokenLocalStorage, NbTokenStorage } from '@core/nebular/auth/services/token/token-storage';
import { NB_AUTH_FALLBACK_TOKEN, NbAuthTokenParceler } from '@core/nebular/auth/services/token/token-parceler';
import { NbDummyAuthStrategy } from '@core/nebular/auth/strategies';
import { nbOptionsFactory, nbStrategiesFactory } from '@core/nebular/auth/auth.module';
import { NbAuthJWTToken, NbAuthSimpleToken} from '@core/nebular/auth/services/token/token';
