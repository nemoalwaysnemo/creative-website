...
export abstract class NbBasePicker<D, T, P> extends NbDatepicker<T> implements OnChanges, OnDestroy {
  ...
  ngOnChanges() {
    if (this.dateService instanceof NbNativeDateService && this.format) {
      throw new Error('Can\'t format native date. To use custom formatting you have to install @core/nebular/moment or ' +
      '@core/nebular/date-fns package and import NbMomentDateModule or NbDateFnsDateModule accordingly.' +
