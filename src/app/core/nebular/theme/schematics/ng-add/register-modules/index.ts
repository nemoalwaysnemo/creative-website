...
function registerNebularModules(options: Schema): Rule {
  return (tree: Tree) => {
    ...
    addModuleImportToRootModule(tree, nebularThemeModule, '@core/nebular/theme', project);
    addModuleImportToRootModule(tree, 'NbLayoutModule', '@core/nebular/theme', project);
  };
}
