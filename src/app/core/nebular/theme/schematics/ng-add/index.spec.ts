...
describe('ng-add', () => {
  ...
  it('should add @core/nebular/theme in package.json', function () {
    const tree = runNgAddSchematic();
    const dependencies = getPackageDependencies(tree);
    const nebularThemeVersion = require('../../package.json').version;

    expect(dependencies['@core/nebular/theme']).toBeDefined();
    expect(dependencies['@core/nebular/theme']).toBe(nebularThemeVersion);
  });
  ...
  it('should register inline theme if no theme already registered', () => {
    ...
    expect(styles).toContain('./node_modules/@core/nebular/theme/styles/prebuilt/default.css');
  });
...
@import '~@core/nebular/theme/styles/globals';
...
`);
    ...
    expect(themes).toContain(`@import '~@core/nebular/theme/styles/theming';
@import '~@core/nebular/theme/styles/themes/default';
