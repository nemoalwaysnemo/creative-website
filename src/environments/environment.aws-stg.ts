...
export enum NUXEO_META_INFO {
  ...
  BIZ_DEV_HOME_SEARCH_FOLDER_TYPE = '["App-BizDev-Case-Studies-Folder", "App-BizDev-ThoughtLeadership-Folder", "App-BizDev-CaseStudy-Asset", "App-BizDev-Thought-Asset"]',
