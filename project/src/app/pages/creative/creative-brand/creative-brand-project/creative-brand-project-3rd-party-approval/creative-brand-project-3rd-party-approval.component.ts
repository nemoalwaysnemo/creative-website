...
@Component({
  selector: 'creative-brand-project-3rd-party-approval',
  templateUrl: './creative-brand-project-3rd-party-approval.component.html',
  styleUrls: ['../../../../../theme/styles/document-metadata-view.scss'],
})
export class CreativeBrandProject3rdPartyApprovalComponent extends GlobalDocumentViewComponent {
