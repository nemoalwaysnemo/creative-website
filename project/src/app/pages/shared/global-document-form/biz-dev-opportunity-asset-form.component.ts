...
@Component({
  selector: 'biz-dev-opportunity-asset-form',
...
export class BizDevOpportunityAssetFormComponent extends GlobalDocumentFormComponent {

  static readonly NAME: string = 'pitch-opportunity-asset-form';

  protected documentType: string = 'App-BizDev-Opportunity-Asset';
