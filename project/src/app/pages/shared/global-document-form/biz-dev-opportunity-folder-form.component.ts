...
@Component({
  selector: 'biz-dev-opportunity-folder-form',
...
export class BizDevOpportunityFolderFormComponent extends GlobalDocumentFormComponent {

  static readonly NAME: string = 'pitch-opportunity-folder-form';

  protected documentType: string = 'App-BizDev-Opportunity';
  ...
  protected getFormModels(): any[] {
    return [
      ...
      new DynamicDragDropFileZoneModel<string>({
        ...
        settings: {
          queueLimit: 1,
          placeholder: 'Drop Folder Image here! <br />This will become the thumbnail for the new Pitch',
          acceptTypes: 'image/*',
        },
      }),
