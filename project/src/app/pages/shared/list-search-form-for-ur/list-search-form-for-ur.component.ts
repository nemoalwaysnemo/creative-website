...
@Component({
  selector: 'list-search-form-for-ur',
  templateUrl: './list-search-form-for-ur.component.html',
  styleUrls: ['../list-search-form/list-search-form.component.scss'],
})
export class ListSearchFormForUrComponent extends BaseSearchFormComponent {
